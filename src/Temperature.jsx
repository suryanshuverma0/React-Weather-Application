  ...
  return (
    <div>
      <div className="flex gap-3 justify-center">
        ...
        <div>
          <Button text="Get Weather" onClick={getWeather} color="blue" />
        </div>
      </div>
      ...
      {weatherData ? 
        <div className="flex justify-center items-center text-center flex-col">
          ...
          <div className="text-slate-400">
            <p className="text-white-200 text-3xl pt-4">{weatherData.weather[0].main}</p>
            <p>Visibility: <span>{weatherData.visibility}</span> m</p>
            <p>Wind Direction: {weatherData.wind.deg}     <span>°</span></p>
          </div>
        </div>
       : null}
